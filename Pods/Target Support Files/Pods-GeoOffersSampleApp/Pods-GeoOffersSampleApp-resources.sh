...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../SDK/GeoOffersSDK/GeoOffersSDK/coupon/coupon.css"
  ...
  install_resource "${PODS_ROOT}/../../SDK/GeoOffersSDK/GeoOffersSDK/GeoOffersNotificationToast.xib"
